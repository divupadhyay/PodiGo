...
import pod5 from '../images/pod5.png'
    ...
    <Card>
      ...
      <CardInformation>
        <MainInfo>
          ...
          <Description>
          In this episode of the Imp And Skizz podcast, they share stories of ghost encounters from their past.
          </Description>
          <CreatorsInfo>
            <Creator>
              <Avatar style={{width:"26px",height:"26px"}}>RS</Avatar>
              <CreatorName>Imp and Skizz</CreatorName>
            </Creator>
            <Views>60k+ Views</Views>
          </CreatorsInfo>
        </MainInfo>
      </CardInformation>
      </div>
